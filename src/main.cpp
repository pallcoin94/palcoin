...
uint256 hashGenesisBlock("0xab848d3e4c102b8732f243790b4f879976418e59eba1f3770edc2a61916c64d9");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xca4cad5701cc567133d1a444aff6ab95815b37f605ad989414875b82d70a25c6");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "pffffffffffffffffffffffffff pffffffffffffffff";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 20 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04f64ad52cb9d0ebd2c536a0863b9aed1eae045f5c22aaa24cfa4536f20b27e35403378629ff44297c0c2b6e63e9db076bd8aefc2f0f15704d8f20c17556c13cd0") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1547925907;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085628740;

        if (fTestNet)
        {
            block.nTime    = 1547925896;
            block.nNonce   = 385640293;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x9d54edead343b2d0d20dcedd6bb9acc4c35d8e7ed652ec5bec2d473c129c8679"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfa, 0xc3, 0xba, 0xd3 }; // Palcoin: increase each by adding 2 to bitcoin's value.
